...
class Config(object):
    ...
    def __init__(self, dataset):
        ...
        self.new_submit_example_path = dataset + '/submit_unlabeled_2label_loss_weight.csv'  # 提交格式
        ...
        self.save_path = dataset + '/saved_dict_torch/' + self.model_name + '1231_mydataset_loss_weight.bin'  # 模型训练结果
