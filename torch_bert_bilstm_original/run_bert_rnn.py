...
class Config(object):
    ...
    def __init__(self, dataset):
        ...
        self.train_path = dataset + '/all_label_valid_3class_1.csv'  # 训练集
        ...
        self.idx2label, self.label2idx = json.load(open(self.id2label_path))  # 类别名单
...
if __name__ == '__main__':
    ...
    for i in range(1, 5):
        ...
        config.train_path = dataset + '/all_label_train_3class_'+str(i)+'.csv'
